...
2. 객관식의 경우 매력적인 오답(함정 선지)을 반드시 포함하여 변별력 확보
3. ${gradeInfo.full} 교육과정과 성취기준에 정확히 부합하는 문제
4. 실제 학교 내신 시험 문체와 형식을 그대로 사용
5. 모든 이미지의 핵심 개념과 세부 내용을 골고루 반영
6. 해설은 왜 정답인지 + 왜 오답인지 함께 설명
7. 문제 간 난이도를 골고루 배분 (쉬운 것부터 어려운 것 순서)
